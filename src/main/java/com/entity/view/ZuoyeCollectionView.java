 ...
 * @date 2021-04-21
 */
@TableName("zuoye_collection")
public class ZuoyeCollectionView extends ZuoyeCollectionEntity implements Serializable {
	...
	public ZuoyeCollectionView() {

	}

	public ZuoyeCollectionView(ZuoyeCollectionEntity zuoyeCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zuoyeCollectionEntity);
