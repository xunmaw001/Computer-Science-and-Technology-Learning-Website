...
var centerMenu = [
    ...
    ,{
        name: '教案收藏',
        url: '../jiaoanCollection/list.jsp'
    }
    ,{
        name: '作业收藏',
        url: '../zuoyeCollection/list.jsp'
    }
...
var adminurl =  "http://localhost:8080/zaixiaoxuexiwangzhan/index.jsp";
