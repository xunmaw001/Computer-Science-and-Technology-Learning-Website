...
<div id="app">
    ...
    <div class="news-container">
        ...
        <div class="content" v-html="myFilters(detail.tongzhiContent)">
        </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function (res) {
            ...
            vue.detail = res.data;
           // 轮播图片
            vue.swiperList = vue.detail.tongzhiPhoto ? vue.detail.tongzhiPhoto.split(",") : [];
            var swiperItemHtml = '';
