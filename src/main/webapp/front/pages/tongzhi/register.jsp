              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">通知名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="tongzhiName" id="tongzhiName"  placeholder="通知名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">通知类型:</span>
                        <div class="layui-input-inline">
                            <select name="tongzhiTypes" id="tongzhiTypes" lay-filter="tongzhiTypes" style="width: 600px;">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'form', 'http', 'jquery', 'laydate'], function() {
      ...
      function tongzhiTypesSelect() {
        //填充下拉框选项
          http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=tongzhi_types", "GET", {}, (res) => {
              if(res.code == 0){
