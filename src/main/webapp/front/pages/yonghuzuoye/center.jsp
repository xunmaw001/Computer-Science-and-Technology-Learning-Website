	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yonghuzuoyeFenshu" id="yonghuzuoyeFenshu"  lay-verify="required|integer"   placeholder="分数" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`yonghuzuoye/session`, 'get', {}, function (data) {
                    // 表单赋值
