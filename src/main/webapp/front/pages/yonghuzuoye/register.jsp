              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">分数:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuzuoyeFenshu" id="yonghuzuoyeFenshu"  lay-verify="integer|required"   placeholder="分数" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
