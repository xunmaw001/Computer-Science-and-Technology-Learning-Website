            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">作业展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../zuoye/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../zuoye/detail.jsp?id='+item.id)"><span>{{item.zuoyeName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 zuoyeContent 字段去除无用字符 如果字段长度大于60  就截取到60
            zuoyeContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function dateTimePick(){
            ...
            */
        // 作业截止时间的开始时间和结束时间的效验及格式
        var zuoyeEndTimeStart = laydate.render({
            elem: '#zuoyeEndTimeStart'
            ,type: 'datetime'
            ,done: function (value, dates) {
                zuoyeEndTimeEnd.config.min={
                    year:dates.year,
        ...
        var zuoyeEndTimeEnd = laydate.render({
            elem: '#zuoyeEndTimeEnd'
            ,type: 'datetime'
            ,done: function (value, dates) {
                zuoyeEndTimeStart.config.max={
                    year:dates.year,
                    month:dates.month-1,//关键
                    date: dates.date,
                    hours:dates.hours,
