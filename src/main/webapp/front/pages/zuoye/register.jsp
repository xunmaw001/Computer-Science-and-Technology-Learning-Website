              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">作业名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zuoyeName" id="zuoyeName"  placeholder="作业名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">作业类型:</span>
                        <div class="layui-input-inline">
                            <select name="zuoyeTypes" id="zuoyeTypes" lay-filter="zuoyeTypes" style="width: 600px;">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">作业截止时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zuoyeEndTime" id="zuoyeEndTime"  placeholder="作业截止时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
