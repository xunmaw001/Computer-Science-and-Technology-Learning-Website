              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">教案名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jiaoanName" id="jiaoanName"  placeholder="教案名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">教案类型:</span>
                        <div class="layui-input-inline">
                            <select name="jiaoanTypes" id="jiaoanTypes" lay-filter="jiaoanTypes" style="width: 600px;">
